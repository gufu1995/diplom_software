...
mc_cb = ModelCheckpoint( filepath = "./rpn/weights_rpn.hdf5", verbose = 1, save_best_only = True )
tb_cb = TensorBoard( log_dir = "./log", profile_batch = 100000000 )
history = rpn.fit_generator( input_gen( ), steps_per_epoch = 10, epochs = 50, callbacks = [ mc_cb, tb_cb ] )
